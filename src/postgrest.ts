 ...
 *   Supabase.flatMapMultipleResponse()
 * )
 * ```
 *
 ...
 * @since 0.1.0
 */
export function flatMapMultipleResponse(): <T>(
 ...
 * ```ts
 * const res = Effect.promise(() => client.from("some_table").select()).pipe(
 *   Supabase.flatMapMultipleResponseWithSchema(SomeTableSchema)
 * )
 * ```
 *
 ...
 *
 * @see {@link filterMapMultipleResponseWithSchema} - Use this if you want to filter out items that fail to decode.
 *
 * @since 0.1.0
 */
export function flatMapMultipleResponseWithSchema<A, I>(
 ...
 * @typeParam I - The type of raw(undecoded) response data.
 *
 * @see {@link flatMapMultipleResponseWithSchema} - Use this if you want to fail when any item fails to decode.
 *
 * @since 0.1.0
 */
export function filterMapMultipleResponseWithSchema<A, I>(
  s: PureSchemaWithEncodedType<A, I>,
  concurrency?: Types.Concurrency
 ...
 *   Supabase.flatMapSingleResponse()
 * )
 * ```
 *
 ...
 * @since 0.1.0
 */
export function flatMapSingleResponse(): <T>(
 ...
 * ```ts
 * const res = Effect.promise(() => client.from("some_table").select().eq('id', 'some-id').single()).pipe(
 *   Supabase.flatMapSingleResponse(SomeTableSchema)
 * )
 * ```
 *
 * @typeParam A - The type of decoded response data.
 ...
 * @since 0.1.0
 */
export function flatMapSingleResponseWithSchema<A, I>(
  s: PureSchemaWithEncodedType<A, I>
): (
 ...
 *   Supabase.flatMapNullableResponse()
 * )
 * ```
 *
 * @typeParam T - The type of response data.
 ...
 * @since 0.1.0
 */
export function flatMapNullableResponse(): <T>(
 ...
 * ```ts
 * const res = Effect.promise(() => client.from("some_table").select().eq('id', 'some-id').maybeSingle()).pipe(
 *   Supabase.flatMapNullableResponseWithSchema(SomeTableSchema)
 * )
 * ```
 *
 * @typeParam A - The type of decoded response data.
 ...
 * @since 0.1.0
 */
export function flatMapNullableResponseWithSchema<A, I>(
  s: PureSchemaWithEncodedType<A, I>
): (
